...
const tabs = [
  { key: 'profile', name: 'الملف الشخصي', icon: User },
  { key: 'notifications', name: 'الإشعارات', icon: Bell },
  { key: 'connection', name: 'الاتصال', icon: Phone },
  { key: 'appearance', name: 'المظهر', icon: Sun },
  { key: 'language', name: 'اللغة', icon: Globe },
];
              ...
              <Tab.List className="w-48 bg-game-card-bg rounded-lg p-2 mr-4">
                {tabs.map((tab) => (
                  <Tab
                    key={tab.key}
                    className={({ selected }) =>
                      `w-full flex items-center gap-2 py-3 px-4 mb-1 rounded-lg text-sm transition-all ${
                        selected
                          ? 'bg-game-primary/20 text-white font-medium'
                          : 'text-gray-400 hover:text-white hover:bg-game-card-bg-alt'
                      }`
                    }
                  >
                ...
                <Tab.Panel className="h-full p-6 outline-none">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div
                        className={`bg-[#0F0C1D] rounded-lg p-4 flex flex-col items-center border-2 hover:border-game-primary cursor-pointer transition-all ${darkMode ? 'border-game-primary' : 'border-transparent'}`}
                      ...
                      <div
                        className={`bg-[#F8F9FA] rounded-lg p-4 flex flex-col items-center border-2 hover:border-game-primary cursor-pointer transition-all ${!darkMode ? 'border-game-primary' : 'border-transparent'}`}
                    ...
                    <div className="mt-8">
                      <button
                        className="w-full py-3 bg-game-primary/20 text-game-primary rounded-lg border border-game-primary/20 hover:bg-game-primary/30 transition-colors"
