    ...
    <div>
      <div className="flex justify-between items-center mb-3">
        ...
        <div className="py-1 px-2 bg-[rgba(255,255,255,0.05)] rounded-full flex items-center gap-1">
          ...
          <span className="text-xs text-[#FF4800] font-['Share_Tech_Mono']">يوم {day}</span>
        </div>
      </div>
      
      <div className="flex items-center gap-4 p-4 bg-[rgba(255,255,255,0.03)] rounded-xl">
        <div className="shrink-0">
          <Target className="h-12 w-12 text-[#FF4800]" strokeWidth={2} />
        </div>
        ...
        <div className="flex-1">
          ...
          <div className="flex justify-between items-center">
            ...
            <Button 
              className="w-[130px] h-[40px] bg-gradient-to-r from-[#FF4800] to-[#CC3900] relative overflow-hidden shimmer-button" 
              size="sm"
            >
